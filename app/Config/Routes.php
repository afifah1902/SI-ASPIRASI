...
$routes->group('admin', ['filter' => 'role:1'], function ($routes) {
	...
	$routes->get('manage-lokasi', 'Lokasi::index');
	...
	$routes->delete('manage-user/aktifkan', 'Admin\ManageUser::aktifkan');

	$routes->get('lokasi', 'Admin/Lokasi::index');
	$routes->get('lokasi/soft_delete/(:num)', 'Lokasi::soft_delete/$1');

});

// Admin - Pengaduan
$routes->group('admin', ['filter' => 'role:1,2,4'], function ($routes) {
	...
	$routes->get('pengaduan/setuju', 'Admin\Pengaduan::pengaduan_setuju');
	$routes->get('pengaduan/tolak1', 'Admin\Pengaduan::tolak1');

	$routes->get('pengaduan/(:num)', 'Admin\Pengaduan::detail/$1');
	$routes->get('pengaduan/detail2/(:num)', 'Admin\Pengaduan::detail2/$1');
	$routes->delete('pengaduan/(:num)', 'Admin\Pengaduan::soft_delete/$1');
	$routes->put('pengaduan/(:num)', 'Admin\Pengaduan::approval/$1');
	$routes->put('pengaduan/rejected1/(:num)', 'Admin\Pengaduan::rejected1/$1');
	$routes->put('pengaduan/rejected2/(:num)', 'Admin\Pengaduan::rejected2/$1');
...
// user
$routes->get('pengaduan', 'Pengaduan::index', ['filter' => 'role:2,3,4']);
$routes->get('pengaduan/(:num)', 'Pengaduan::detail/$1', ['filter' => 'role:2,3,4']);
$routes->delete('pengaduan/(:num)', 'Pengaduan::soft_delete/$1', ['filter' => 'role:2,3,4']);

$routes->get('user/ubah-password', 'User::ubah_password');
$routes->delete('lokasi/delete/(:num)', 'Admin\KelolaLokasi::delete/', ['filter' => 'role:1']);
/*
 * --------------------------------------------------------------------
 * Additional Routing
 * --------------------------------------------------------------------
