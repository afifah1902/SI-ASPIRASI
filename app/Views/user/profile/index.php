                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><span class="badge badge-info"> <?= ($data['user_level'] == 1 ? 'Petugas Pemdes' : ($data['user_level'] == 2 ? 'Ketua RT': ($data['user_level'] == 3 ? 'Masyarakat' : 'Kepala Desa'))); ?></span></li>
                            ...
                            <li class="list-group-item"><i class="fas fa-fw fa-map-marker"></i> Lokasi : RT <?= $data['lokasi_user']; ?></li>
