                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="judul_aspirasi" id="judul" class="form-control <?= $validation->hasError('judul_aspirasi') ? 'is-invalid' : ''; ?>" value="<?= old('judul_aspirasi'); ?>" autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="isi_aspirasi" id="isi" cols="30" rows="13" class="form-control <?= $validation->hasError('isi_aspirasi') ? 'is-invalid' : ''; ?>"><?= old('isi_pengaduan'); ?></textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input anonym" type="radio" name="nama_pengirim" id="nama_pengirim1" value="anonym" checked>
                                    <label class="form-check-label" for="nama_pengirim1">
                                        <span class="text-gray-800">Samarkan (anonym)</span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="nama_pengirim" id="nama_pengirim2">
