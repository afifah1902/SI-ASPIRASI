    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <a href="/admin/manage-user">&laquo; Kembali ke daftar pengguna belum terverifikasi</a>
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            ...
                            <?php if ($data['is_active'] == 0) : ?>
                                ...
                                <button type="button" data-toggle="modal" data-target="#user-approval" class="btn btn-primary btn-block">Aktifkan</button>
                            <?php endif; ?>

                            <?php if ($data['is_active'] == 1) : ?>
                                <hr class="sidebar-divider">

                                <button type="button" data-toggle="modal" data-target="#modal-hapus" class="btn btn-primary btn-danger">Nonaktifkan</button>
                            <?php endif; ?>
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-0"><b>Daftar Sebagai: </b><?= ($data['user_level'] == 1 ? 'Petugas Pemdes' : ($data['user_level'] == 2 ? 'Ketua RT': ($data['user_level'] == 3 ? 'Masyarakat' : 'Kepala Desa'))); ?></p>
                                <p class="card-text mb-0"><b>Lokasi: </b> RT <?= $data['lokasi_user']; ?></p>
                                <hr class="sidebar-divider">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <span class="text-gray-900">Klik "Aktif" untuk konfirmasi pengaktifan akun pengguna.</span>
                        <?= csrf_field(); ?>
        ...
        <div class="modal fade" id="modal-hapus" tabindex="-1" role="dialog" aria-labelledby="modal-hapusLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-hapusLabel">Yakin ingin nonaktifkan pengguna?</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <span class="text-gray-900">Klik "Nonaktif" untuk konfirmasi nonaktif pengguna.</span>
                        <?= csrf_field(); ?>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-primary btn-yakin">Nonaktif</button>
                    </div>
                    <?= form_close(); ?>
                </div>
            </div>
