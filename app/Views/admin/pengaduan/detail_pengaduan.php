...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card shadow card-detail">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <?php if ($data['status_aspirasi'] == 2) : ?>
                                <button type="button" class="btn btn-sm btn-primary disabled"><i class="fas fa-info-circle"></i> Aspirasi Disetujui RT</button>
                            <?php elseif ($data['status_aspirasi'] == 1)  : ?>
                                <button type="button" data-toggle="modal" data-target="#approval" class="btn btn-sm btn-primary"><i class="fas fa-check"></i> Setuju</button>
                                <button type="button" data-toggle="modal" data-target="#rejected1" class="btn btn-sm btn-danger"><i class="fas fa-minus"></i>  Tolak </a></button>
                                <?php else :?>
                                <button type="button" class="btn btn-sm btn-danger disabled"><i class="fas fa-info-circle"></i> Aspirasi Ditolak RT</button>
                            <?php endif; ?>
                            </div>
                    </div>
                    <hr>
    ...
    <div class="modal fade" id="rejected1" tabindex="-1" role="dialog" aria-labelledby="rejected1Label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?= form_open('/admin/pengaduan/rejected1/' . $data['id'], ['class' => 'd-inline', 'id' => 'formRejectedPengaduan']); ?>
            <div class="modal-header">
                <h5 class="modal-title" id="rejected1Label">Yakin ingin menolak aspirasi?</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <span class="text-gray-900">Klik tombol "Yakin" untuk menolak status aspirasi.</span>
...
<script>
    $(document).ready(function() {
        $("#formRejected1Pengaduan").submit(function(e) {
            e.preventDefault()
