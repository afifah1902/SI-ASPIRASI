...
class ManageUserModel extends Model
{
    ...
    {
        parent::__construct();
        $this->dt = $this->db->table($this->table)->select('id, username, user_image, nama, is_active, user_level');
        ...
        $this->rt = $this->db->table($this->table)->select('id, username, user_image, nama, is_active, user_level')->where(['row_status' => 1, 'user_level' => 2]);
        $this->ms = $this->db->table($this->table)->select('id, username, user_image, nama, is_active, user_level')->where(['row_status' => 1, 'user_level' => 3]);
    }
